...
#include <stdlib.h>
#include <locale.h>
#include "tauansilva20192160033.h"
...
int q1(char *data)
{
    ...
    int contaCorretos = 0;
    while(data[tamanhoData] != '/')
    {
        if(data[tamanhoData] >= '0' && data[tamanhoData] <= '9')
        {
            contaCorretos++;
        }
        tamanhoData++;
    ...
    tamanhoData++;
    contaCorretos = 0;
    while(data[tamanhoData] != '\0' || tamanhoData < 10)
    {
        if(data[tamanhoData] >= '0' && data[tamanhoData] <= '9')
        {
            contaCorretos++;
    ...
    while( data[tamanhoData] != '\0' || tamanhoData < 10)
    {
        if (data[tamanhoData] == '/' && (tamanhoData >= 1 && tamanhoData <= 5))
        {
            contaCorretos++;
        }
        tamanhoData++;
